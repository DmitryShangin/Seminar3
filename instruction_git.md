...
GitHub позволяет пользователям участвовать в определённом проекте, общаться с единомышленниками. Вы можете следить за людьми и смотреть, что они делают или с кем они общаются.
